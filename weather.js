...
var API_KEY = "70abe480196682c4e522136544b6489c";
...
function getData(QUERY) {
  ...
  $.ajax({
    ...
    $.ajax({
      url:
        uvURL +
        formatUVQuery(weatherRes.coord.lon, weatherRes.coord.lat) +
        API_KEY,
      method: "GET"
    }).then(function(uvRes) {
  ...
  $.ajax({
    ...
    var icon5dayURL1 =
      "https://openweathermap.org/img/wn/" + icon5dayPath1 + "@2x.png";
    ...
    var icon5dayURL2 =
      "https://openweathermap.org/img/wn/" + icon5dayPath2 + "@2x.png";
    ...
    var icon5dayURL3 =
      "https://openweathermap.org/img/wn/" + icon5dayPath3 + "@2x.png";
    ...
    var icon5dayURL4 =
      "https://openweathermap.org/img/wn/" + icon5dayPath4 + "@2x.png";
    ...
    var icon5dayURL5 =
      "https://openweathermap.org/img/wn/" + icon5dayPath5 + "@2x.png";
...
function renderButons() {
  ...
  for (i = 0; i < cities.length; i++) {
    newCity = $("<button></button>")
      .append(cities[i])
      .addClass("btn btn-light m-1 searches mb-2");
